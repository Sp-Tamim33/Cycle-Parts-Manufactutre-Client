...
const OverviewCard = ({ icon, limit, text }) => {
    ...
    return (
        <div className='pt-10 max-w-7xl mx-auto flip-card my-3'>
            <div className="card bg-orange-200 shadow-xl px-10 py-8 rounded-[30px]">
                <div className="card-body text-black">
                    <h2 className="card-title text-7xl"><Icon className='mx-auto text-orange-500' icon={icon} /></h2>
