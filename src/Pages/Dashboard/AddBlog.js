                ...
                <div className="shadow-lg bg-slate-600 rounded-lg  w-full lg:w-10/12 p-5 md:px-10 ">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="mb-3 ">
                            ...
                            <div className="mb-3 ">
                                <label for="file_input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Blog Image</label>
                            ...
                            <div>
                                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Writer Name</label>
                                <input
                                    id='name'
                                    required
                            ...
                            <div className='py-2'>
                                <label for="question" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Blog Question</label>
                                <input
                                    id='question'
                                    required
                                    className="block p-2.5 w-80 text-sm text-gray-900 bg-gray-50 rounded-lg border border-orange-500 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500"
                            ...
                            <div>
                                <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Blog Description</label>
                                <textarea {...register("description")} required id="description" rows="4" class="block p-2.5 w-80 text-sm text-gray-900 bg-gray-50 rounded-lg border border-orange-500 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500" placeholder="Blog Description"></textarea>
                            </div>
                        </div>
